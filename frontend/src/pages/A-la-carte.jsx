...
import aLaCarteImageSmall from "../assets/a-la-carte-compressed.png";
import { useState, useEffect } from "react";

export default function ALaCarte() {
  const [heroImage, setHeroImage] = useState(aLaCarteImageSmall);
  ...
  useEffect(() => {
    preloadImage(setHeroImage, setHeroLoaded, aLaCarteImage);
  }, []);
      ...
      <main className="menu-hero-content">
        ...
        <article className="menu-description-article">
          <p className="description-title">
            Smaker skapade i harmoni med naturen
          </p>
          <p className="description-body">
            Välkommen till ett kök där passionen är den viktigaste ingrediensen.
            Under ledning av vår köksmästare Luciano Rossi skapar vi mat som
            talar till alla sinnen. Luciano och hans team arbetar med en
            sällsynt precision och kärlek till detaljerna, vilket märks i allt
            från den första aromen till det vackra upplägget.
          </p>

          <p className="description-body">
            Vi tror på rena smaker och noggrant utvalda råvaror som får tala för
            sig själva. För att göra din kväll komplett hjälper vi dig mer än
            gärna att hitta rätt dryck. Det där lilla extra som förgyller varje
            tugga. <br />
            <br />
            Välkommen att slå dig ner, koppla av och låt oss sköta resten. Vi
            lovar att du kommer trivas.
          </p>

          <div className="practical-info-box">
            <p className="practical-info-title">Bordsbokning:</p>
            <p className="practical-info-text">
              Gör din reservation på <strong>070-123 45 67</strong> eller via
              mail på
              <strong> info@roslagenescape.se</strong>. <br />
              För våra boendegäster bokas middagstiden bekvämt på plats vid
              ankomst.
            </p>
        ...
        <section className="menu-items-container">
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Serveras med tryffelmajonnäs, picklad skogssvamp, krispig
              schalottenlök och riven lagrad svecia.
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Ett urval av lokala charkuterier, oliver, fröknäcke och en
              sötstark fikonmarmorlad.
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Med blomkålspuré, brynt smör-vinägrett, hasselnötter och färsk
              körvel.
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Ugnsrostade gul- och polkarbetor, krämig getostkräm,
              honungsgravade valnötter och ruccola. (V)
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Med rödvinssås på oxmärg, örtsmör, säsongens primörer och krispig
              pommes frites.
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Bräserad i mörkt öl, serveras med en len potatispuré med
              västerbottensost, picklad lök och rårörda vinbär.
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              På briochebröd med karamelliserad lök, rökt bacon, tryffelaioli
              och handskuren klyftpotatis.
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Från kalla vatten, serveras med sandefjordssås, sparris, forellrom
              och dillslungad färskpotatis.
            </p>
            <p className="dish-wine-pairing">
              Riesling Trocken, Tyskland, 145 kr
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Med pepparrot, brynt smör, rimmad gurka, handskalade räkor och
              kokt delikatesspotatis.
            </p>
            <p className="dish-wine-pairing">
              Meursault Chardonnay, Frankrike, 185 kr
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Krämig arborioris med säsongens svamp, sparris, parmesanflarn och
              en skvätt vit tryffelolja. (V)
            </p>
            <p className="dish-wine-pairing">
              Barolo Nebbiolo, Italien, 175 kr
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Serveras med en nötig romescosås, belugalinser, hyvlad fänkål och
              rostade mandlar. (VG)
            </p>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Med rinnande kärna, serveras med rårörda hallon och en kula krämig
              vaniljgelato.
            </p>
            <p className="dish-wine-pairing">
              Recioto della Valpolicella, Italien, 115 kr (8cl)
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Smaksatt med äkta tahitivanilj och toppad med ett knäckigt
              sockerlager.
            </p>
            <p className="dish-wine-pairing">
              Sauternes, Frankrike, 105 kr (8cl)
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              "Norrlands guld" serveras med havreflarn, brynt smör-smulor och
              färsk mynta.
            </p>
            <p className="dish-wine-pairing">
              Tokaji Aszú, Ungern, 125 kr (8cl)
            </p>
          </div>
        </section>
      </main>
