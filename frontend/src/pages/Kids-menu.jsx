...
import kidsMenuImageSmall from "../assets/kids-menu-compressed.png";
      ...
      <main className="menu-hero-content">
        ...
        <article className="menu-description-article">
          ...
          <p className="description-body">
            På Roslagen Escape är hela familjen huvudpersoner. Vi vet att stora
            äventyr kräver ordentligt med energi, och därför har vårt köksteam
            skapat en meny med barnens absoluta favoriter. Självklart tillagade
            med samma kärlek och noggrant utvalda råvaror som resten av husets
            mat.
          </p>

          <p className="description-body">
            Här får de minsta njuta av välkända smaker i en varm och lekfull
            miljö, där varje rätt är komponerad för att ge både matglädje och
            ork till morgondagens upptåg i naturen.
          </p>
        ...
        <section className="menu-items-container">
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Tre fluffiga pannkakor som serveras med vispad grädde och husets
              hemkokta jordgubbssylt.
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Klassiska köttbullar som serveras med en len potatispuré, rårörda
              lingon och en mild gräddsås.
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Smörstekt torskrygg som serveras med kokt potatis, gröna ärtor och
              en klick kall citronsås.
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              En saftig hamburgare (90g) på briochebröd med krispiga pommes
              frites och mild ketchup på sidan.
            </p>
          </div>
          ...
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Två kulor krämig vaniljglass toppad med varm chokladsås och ett
              krispigt rån.
            </p>
          </div>
          <div className="dish-wrapper">
            ...
            <p className="dish-ingredients">
              Säsongens färska bär som serveras med en liten klick lättvispad
              grädde.
            </p>
          </div>
        </section>
